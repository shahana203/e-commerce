...
import electronics_banner_1 from './electronics_banner_1.png'
import electronics_banner_2 from './electronics_banner_2.png'
...
export const assets ={logo,
    ...
    stripe_logo,
    cross_icon,
    electronics_banner_1,
    electronics_banner_2,blog4}
export const products = [
    ...
    {
        _id: "22",
        name: "boAt Blitz 2000 2.1 Channel Multimedia Speaker",
        description: "Experience powerful sound with deep bass and vibrant LED lighting — perfect for music, movies, and gaming.",
        price: 400,
        image: [img22],
        category: "Speakers",
        colors: ["Red", "White", "Blue"],
